...
function Navigation() {
  ...
  return (
    <main>
      ...
      <section className="home_nav_section_menu">
        <header className={`home_logo ${isToggled ? 'show_logo' : 'hide_logo'}`}>
          <button onClick={() => setIsToggled(!isToggled)} type="button" aria-label="button">
            <img src={menuImg} alt="" />
          </button>
        </header>

        <header className={`home_logo ${isToggled ? 'hide_logo' : 'show_logo'}`}>
          <button onClick={() => setIsToggled(!isToggled)} type="button" aria-label="button">
      ...
      <section className="home_nav_section">
        <header className="home_logo hide_logo">
          <figure>
